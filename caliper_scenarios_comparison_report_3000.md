...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Case 1** | P1 OR P2 | 3000 | 0 | 30 | 0.17s | 30 | **100.0%** |
| **Case 2** | P1 AND P2 | 3000 | 0 | 30 | 0.17s | 30 | **100.0%** |
| **Case 3** | P1 AND P2 | 3000 | 0 | 30 | 0.16s | 30 | **100.0%** |
| **Case 4** | P1 OR P2 | 3000 | 0 | 30 | 0.17s | 30 | **100.0%** |
| **Case 5** | P1 OR P2 | 3000 | 0 | 30 | 0.16s | 30 | **100.0%** |
| **Case 6** | P1 AND P2 | 3000 | 0 | 30 | 0.17s | 30 | **100.0%** |
| **Case 7** | P1 OR P2 | 3000 | 0 | 30 | 0.16s | 30 | **100.0%** |
| **Case 8** | P1 AND P2 | 3000 | 0 | 30 | 0.17s | 30 | **100.0%** |

## Performance Metrics: `transfer-funds` round

| Scenario | Policy Type | Success | Fail | Send Rate (TPS) | Avg Latency (s) | Throughput (TPS) | Success % |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Case 1** | P1 AND P2 | 2982 | 18 | 50.1 | 0.12s | 50 | **99.4%** |
| **Case 2** | P1 OR P2 | 2984 | 16 | 50.1 | 0.12s | 50 | **99.5%** |
| **Case 3** | P1 AND P2 | 2975 | 25 | 50.1 | 0.12s | 50 | **99.2%** |
| **Case 4** | P1 OR P2 | 2981 | 19 | 50.1 | 0.12s | 50 | **99.4%** |
| **Case 5** | P1 AND P2 | 2983 | 17 | 50.1 | 0.12s | 50 | **99.4%** |
| **Case 6** | P1 OR P2 | 2981 | 19 | 50.1 | 0.13s | 50 | **99.4%** |
| **Case 7** | P1 OR P2 | 2981 | 19 | 50.1 | 0.14s | 50 | **99.4%** |
| **Case 8** | P1 AND P2 | 2979 | 21 | 50.1 | 0.12s | 50 | **99.3%** |

## Performance Metrics: `approve-loan` round

| Scenario | Policy Type | Success | Fail | Send Rate (TPS) | Avg Latency (s) | Throughput (TPS) | Success % |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Case 1** | P1 AND P2 | 1500 | 1500 | 15 | 0.41s | 15 | **50.0%** |
| **Case 2** | P1 AND P2 | 1500 | 1500 | 15 | 0.41s | 15 | **50.0%** |
| **Case 3** | P1 OR P2 | 1500 | 1500 | 15 | 0.42s | 15 | **50.0%** |
| **Case 4** | P1 AND P2 | 1500 | 1500 | 15 | 0.41s | 15 | **50.0%** |
| **Case 5** | P1 OR P2 | 1500 | 1500 | 15 | 0.41s | 15 | **50.0%** |
| **Case 6** | P1 OR P2 | 1500 | 1500 | 15 | 0.41s | 15 | **50.0%** |
| **Case 7** | P1 OR P2 | 1500 | 1500 | 15 | 0.42s | 15 | **50.0%** |
| **Case 8** | P1 AND P2 | 1500 | 1500 | 15 | 0.42s | 15 | **50.0%** |
