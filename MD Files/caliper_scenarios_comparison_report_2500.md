...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Case 1** | P1 OR P2 | 2500 | 0 | 30.1 | 0.12s | 30 | **100.0%** |
| **Case 2** | P1 AND P2 | 2500 | 0 | 30.1 | 0.12s | 30 | **100.0%** |
| **Case 3** | P1 AND P2 | 2500 | 0 | 30.1 | 0.12s | 30 | **100.0%** |
| **Case 4** | P1 OR P2 | 2500 | 0 | 30.1 | 0.12s | 30 | **100.0%** |
| **Case 5** | P1 OR P2 | 2500 | 0 | 22.3 | 0.17s | 22.3 | **100.0%** |
| **Case 6** | P1 AND P2 | 2500 | 0 | 30.1 | 0.12s | 30 | **100.0%** |
| **Case 7** | P1 OR P2 | 2500 | 0 | 30.1 | 0.12s | 30 | **100.0%** |
| **Case 8** | P1 AND P2 | 2500 | 0 | 30.1 | 0.12s | 30 | **100.0%** |

## Performance Metrics: `transfer-funds` round

| Scenario | Policy Type | Success | Fail | Send Rate (TPS) | Avg Latency (s) | Throughput (TPS) | Success % |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Case 1** | P1 AND P2 | 2486 | 14 | 50.1 | 0.09s | 50.1 | **99.4%** |
| **Case 2** | P1 OR P2 | 2486 | 14 | 50.1 | 0.08s | 50 | **99.4%** |
| **Case 3** | P1 AND P2 | 2485 | 15 | 50.1 | 0.08s | 50.1 | **99.4%** |
| **Case 4** | P1 OR P2 | 1752 | 748 | 27.3 | 0.79s | 26.7 | **70.1%** |
| **Case 5** | P1 AND P2 | 2482 | 18 | 50.1 | 0.09s | 50 | **99.3%** |
| **Case 6** | P1 OR P2 | 2489 | 11 | 50.1 | 0.08s | 50.1 | **99.6%** |
| **Case 7** | P1 OR P2 | 2476 | 24 | 50.1 | 0.08s | 50.1 | **99.0%** |
| **Case 8** | P1 AND P2 | 2483 | 17 | 50.1 | 0.08s | 50.1 | **99.3%** |

## Performance Metrics: `approve-loan` round

| Scenario | Policy Type | Success | Fail | Send Rate (TPS) | Avg Latency (s) | Throughput (TPS) | Success % |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Case 1** | P1 AND P2 | 1250 | 1250 | 15 | 0.37s | 15 | **50.0%** |
| **Case 2** | P1 AND P2 | 1250 | 1250 | 15 | 0.37s | 15 | **50.0%** |
| **Case 3** | P1 OR P2 | 1250 | 1250 | 15 | 0.37s | 15 | **50.0%** |
| **Case 4** | P1 AND P2 | 1250 | 1250 | 15 | 0.36s | 15 | **50.0%** |
| **Case 5** | P1 OR P2 | 1250 | 1250 | 15 | 0.38s | 15 | **50.0%** |
| **Case 6** | P1 OR P2 | 1250 | 1250 | 15 | 0.37s | 15 | **50.0%** |
| **Case 7** | P1 OR P2 | 1250 | 1250 | 15 | 0.37s | 15 | **50.0%** |
| **Case 8** | P1 AND P2 | 1250 | 1250 | 15 | 0.37s | 15 | **50.0%** |
