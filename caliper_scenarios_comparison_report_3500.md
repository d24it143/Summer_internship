...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Case 1** | P1 OR P2 | 3500 | 0 | 30 | 0.16s | 30 | **100.0%** |
| **Case 2** | P1 AND P2 | 3500 | 0 | 30 | 0.17s | 30 | **100.0%** |
| **Case 3** | P1 AND P2 | 3500 | 0 | 30 | 0.17s | 30 | **100.0%** |
| **Case 4** | P1 OR P2 | 3500 | 0 | 30 | 0.17s | 30 | **100.0%** |
| **Case 5** | P1 OR P2 | 3500 | 0 | 30 | 0.16s | 30 | **100.0%** |
| **Case 6** | P1 AND P2 | 3500 | 0 | 30 | 0.16s | 30 | **100.0%** |
| **Case 7** | P1 OR P2 | 3500 | 0 | 30 | 0.16s | 30 | **100.0%** |
| **Case 8** | P1 AND P2 | 3500 | 0 | 30 | 0.16s | 30 | **100.0%** |

## Performance Metrics: `transfer-funds` round

| Scenario | Policy Type | Success | Fail | Send Rate (TPS) | Avg Latency (s) | Throughput (TPS) | Success % |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Case 1** | P1 AND P2 | 3483 | 17 | 50.1 | 0.12s | 50 | **99.5%** |
| **Case 2** | P1 OR P2 | 3480 | 20 | 50.1 | 0.12s | 50 | **99.4%** |
| **Case 3** | P1 AND P2 | 3476 | 24 | 50.1 | 0.12s | 50 | **99.3%** |
| **Case 4** | P1 OR P2 | 3486 | 14 | 50.1 | 0.12s | 50 | **99.6%** |
| **Case 5** | P1 AND P2 | 3484 | 16 | 50 | 0.13s | 50 | **99.5%** |
| **Case 6** | P1 OR P2 | 3484 | 16 | 50 | 0.13s | 50 | **99.5%** |
| **Case 7** | P1 OR P2 | 3487 | 13 | 50.1 | 0.13s | 50 | **99.6%** |
| **Case 8** | P1 AND P2 | 3479 | 21 | 50.1 | 0.13s | 50 | **99.4%** |

## Performance Metrics: `approve-loan` round

| Scenario | Policy Type | Success | Fail | Send Rate (TPS) | Avg Latency (s) | Throughput (TPS) | Success % |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Case 1** | P1 AND P2 | 1750 | 1750 | 15 | 0.41s | 15 | **50.0%** |
| **Case 2** | P1 AND P2 | 1750 | 1750 | 15 | 0.41s | 15 | **50.0%** |
| **Case 3** | P1 OR P2 | 1750 | 1750 | 15 | 0.42s | 15 | **50.0%** |
| **Case 4** | P1 AND P2 | 1750 | 1750 | 15 | 0.41s | 15 | **50.0%** |
| **Case 5** | P1 OR P2 | 1750 | 1750 | 15 | 0.4s | 15 | **50.0%** |
| **Case 6** | P1 OR P2 | 1750 | 1750 | 15 | 0.4s | 15 | **50.0%** |
| **Case 7** | P1 OR P2 | 1750 | 1750 | 15 | 0.42s | 15 | **50.0%** |
| **Case 8** | P1 AND P2 | 1750 | 1750 | 15 | 0.41s | 15 | **50.0%** |
